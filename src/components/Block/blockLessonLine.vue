<template>
  <div class="block-lesson" @click="detailClick">
    ...
    <div v-if="dataSource.title && dataSource.time" class="disp-flex justify-between">
      <div class="title">{{dataSource.title}}</div>
      <div>{{dataSource.time}}</div>
    </div>
    <div v-if="dataSource.hot" class="intro">{{dataSource.hot}}</div>
